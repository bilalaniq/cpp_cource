...
the proof that the templete function or class are created when we call them is 
template <typename T>
void print(T variable)
{
    cout << var << endl;                !!!!!!!!!!!!!!!!error in this line
}
...
i have not called the function and the function has error but it will still compile but when i call the funtion it will show error
MVS will not show error but the VScode will show error it is compile based but it proofs that templates function are 
